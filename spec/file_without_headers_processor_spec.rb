...
# RSpec.describe CSVConverter::FileWithoutHeadersProcessor do
#   describe 'mappings with class names' do
#     let(:mappings_filename) { 'sales_mappings_without_headers_and_converters_names.yml' }
...
#     let(:csv_file_path) { file_fixture('sales_without_headers.csv') }
...
#   describe 'mappings with aliases' do
#     let(:mappings_filename) { 'sales_mappings_with_headers_and_converters_aliases.yml' }
#     let(:mappings_file_path) { file_fixture(mappings_filename) }
#     let(:mappings) { YAML.load_file(mappings_file_path).deep_symbolize_keys[:mappings] }
